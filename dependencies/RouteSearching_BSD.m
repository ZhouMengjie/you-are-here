function [location, rank, best_top5_routes, route_dist] = RouteSearching_BSD(routes, N, max_route_length, threshold, R_init, t, T, turns_flag, min_num_candidates,topk, overlap)
R = R_init;
